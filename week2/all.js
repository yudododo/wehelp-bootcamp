...
const absoluteDis = fStationIndex.map((value) => Math.abs(value - currentStationIndex));
...
let closestFriendName = friend[closestFriendIndex];
 ...
 const line = ["Songshan", "Nanjing Sanmin", "Taipei Arena", "Nanjing Fuxing", "Songjiang Nanjing", "Zhongshan", "Beimen", "Ximen", "Xiaonanmen", "Chiang Kai-Shek Memorial Hall", "Guting", "Taipower Building", "Gongguan", "Wanlong", "Jingmei", "Dapinglin", "Qizhang", ["Xiaobitan", "Xindian City Hall"], "Xindian"]
...
function book(consultants, hour, duration, criteria){ 
  ...
  for (let consultant of consultants) {
    ...
    const isAvailable = !bookedHours.some(bookedHour => hours.includes(bookedHour));
